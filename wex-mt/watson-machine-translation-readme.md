...
The [Watson Machine Translation Service](http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/machine-translation.html) enables text to be translated from one languae to another.  The October 2014 release includes 7 languages with more to be included in the coming months.  This sample code demonstrates the use of Spanish to English and English to Spanish.
